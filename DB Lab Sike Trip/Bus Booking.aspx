...
<asp:Content ID="Content2" ContentPlaceHolderID="HomeContent" runat="server">
    ...
    <section>
     ...
     <section id ="DisplayBusBooking" class="viewProfile" visible = "true" runat ="server"> <%--it disappers bcz of this--%>
        ...
        <div class="item">
          <p>Bus Make</p>
              <asp:textBox runat="server" id="display_booking_busmake" style="border: none"  ReadOnly="True"></asp:textBox> 
        </div>
        <div class="item">
          <p>License Number</p>
          <asp:textBox runat="server" id="display_booking_licensenumber" style="border: none"  ReadOnly="True"></asp:textBox> 
        </div>
        <div class="item">
        ...
        <asp:textBox runat="server" id="display_booking_bus_reservation_count" style="border: none"  ReadOnly="True"></asp:textBox> 
        </div>
         </section>
