            ...
            <hr>
              <div class="row">
                ...
                <section id="btn" class="testbox">   
                   ...
                   <asp:Button ID="ViewBusBookingButton" Text="Confirm Tour Booking" runat="server" class="btn btn-danger" CssClass="btn btn-danger" OnClick="TourBookingButton_Click" OnClientClick="return validate()" ></asp:Button>
