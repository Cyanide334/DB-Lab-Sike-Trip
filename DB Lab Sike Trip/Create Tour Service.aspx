            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                 ...
                 <div class="row mt-3">
                    ...
                    <div class="col-md-6"><label class="labels">Departure Time</label><asp:TextBox ID="Dtime" runat="server" placeholder="hh:mm am(or)pm" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-md-6"><label class="labels">Arrival Time</label><asp:TextBox ID="Atime" runat="server" placeholder="hh:mm am(or)pm" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-md-6"><label class="labels">Return Time</label><asp:TextBox ID="Rtime" runat="server" placeholder="hh:mm am(or)pm" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><label class="labels">Bus License Number</label><asp:TextBox ID="BusNum" runat="server" placeholder="Tour Bus License Number" CssClass="form-control"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
